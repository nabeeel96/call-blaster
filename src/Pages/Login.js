      ...
      useEffect (() => {
        ...
        if(checked){
            ...
            if(user!="" && user!="undefined" && user!=undefined)
                setRecord({'username': user,'password': localStorage.getItem('password')});
        }
    }, [User])
        ...
        <div style={layoutStyle}>
            ...
            <Col  xs={0} sm={0} md={4} lg={4} >
                <div style={leftboxStyle}>
                    ...
                    <h1 style={{color:'#fff'}} >Telecard's first ever admin panel created by the great Kalmati developer</h1>
                </div>
            </Col>
